...
ACQ_TB_STOP_TIME="${ACQ_TB_STOP_TIME:-140ms}"
ACQ_INPUT_FILE="${ACQ_INPUT_FILE:-2013_04_04_GNSS_SIGNAL_at_CTTC_SPAIN/2013_04_04_GNSS_SIGNAL_at_CTTC_SPAIN.dat}"
ACQ_FILE_SAMPLE_RATE_SPS="${ACQ_FILE_SAMPLE_RATE_SPS:-4000000}"
